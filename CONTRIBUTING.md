# Contributing to nextjs-kanban

> Welcome to `nextjs-kanban`
...
Please start by reading our [license](https://github.com/whosramoss/nextjs-kanban/blob/master/LICENSE) and [code-of-conduct](https://github.com/whosramoss/nextjs-kanban/blob/master/CODE_OF_CONDUCT.md). If you don't agree with them, this isn't your project.
...
Main contribution ways are to [open issues](https://github.com/whosramoss/nextjs-kanban/issues) and [fork with later pull requests](https://github.com/whosramoss/nextjs-kanban/network/members). Furthermore, you can discuss issues, review **PRs** or mention this project in _public/chat_ with the community about your experience.
